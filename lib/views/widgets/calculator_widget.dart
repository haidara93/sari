            ...
            child: Column(
              ...
              children: [
                    ...
                    Visibility(
                      ...
                      child: SizedBox(
                        ...
                        child: CheckboxListTile(
                            ...
                            controlAffinity: ListTileControlAffinity.leading,
                            title:
                                const Text("قياس الأنابيب أقل أو يساوي 3inch؟"),
                            onChanged: (value) {
                              calculatorProvider.calculateExtrasPrice(
                                  .1, value!);
                              widget.valueController!.text =
                ...
                TextFormField(
                  ...
                  style: const TextStyle(fontSize: 18),
                  decoration: InputDecoration(
                    labelText: calculatorProvider.wieghtLabel,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ),
                      Text(
                        "القيمة الاجمالية بالدولار :${f.format(double.parse(calculatorProvider.syrianExchangeValue).toInt())}\$",
                        style: TextStyle(fontSize: 17.sp),
                      ),
                      Text(
                        "القيمة الاجمالية بجنيه المصري :${f.format(double.parse(calculatorProvider.syrianTotalValue).toInt())} E.P",
                        style: TextStyle(fontSize: 17.sp),
                      ),
                      Text(
                        "قيمة البضاعة مع التأمين: ${f.format(double.parse(calculatorProvider.totalValueWithEnsurance).toInt())} E.P",
                        style: TextStyle(fontSize: 17.sp),
                      ),
                    ],
                  ),
                          ...
                          return CustomButton(
                              onTap: () {
                                ...
                                if (widget.calformkey.currentState!
                                    .validate()) {
                                  if (calculatorProvider.selectedOrigin !=
                                      null) {
