...
class _StepperOrderBrokerScreenState extends State<StepperOrderBrokerScreen> {
  ...
  String originPlaceholder = "اختر مصدر";
                            ...
                            children: [
                                  ...
                                  child: DropdownButton2<StateCustome>(
                                    ...
                                    onChanged: (StateCustome? value) {
                                      BlocProvider.of<AgencyBloc>(context)
                                          .add(AgenciesLoadEvent(value!.id!));
                                      setState(() {
                              ...
                              BlocBuilder<AgencyBloc, AgencyState>(
                                builder: (context, state2) {
                                  if (state2 is AgencyLoadedSuccess) {
                                    return DropdownButtonHideUnderline(
                                      child: Focus(
                                        ...
                                        child: DropdownButton2<CustomeAgency>(
                                          isExpanded: true,
                                          hint: Text(
                                            agencyPlaceholder,
                                            style: TextStyle(
                                  ...
                                  } else if (state2 is AgencyLoadingProgress) {
                                    return const Center(
                                      child: LinearProgressIndicator(),
                                    );
                                  } else if (state is AgencyLoadedFailed) {
                                    return Center(
                                      child: GestureDetector(
                                        onTap: () {
                                          BlocProvider.of<AgencyBloc>(context)
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                      height: 140.h,
                      child: BlocBuilder<PackageTypeBloc, PackageTypeState>(
                        builder: (context, state) {
                                ...
                                child: TextField(
                                  ...
                                  onTap: () {
                                    ...
                                    _tabalehNumController.selection =
                                        TextSelection(
                                            baseOffset: 0,
                                            extentOffset: _tabalehNumController
                                                .value.text.length);
                                  },
                                  onChanged: (value) {
                                    if (value.isEmpty) {
                      ...
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          onTap: () {
                            ...
                            BlocProvider.of<BottomNavBarCubit>(context)
                                .emitHide();
                            _packagesNumController.selection = TextSelection(
                                baseOffset: 0,
                                extentOffset:
                                    _packagesNumController.value.text.length);
                          },
                          onChanged: (value) {
                            if (value.isEmpty) {
                              setState(() {
              ...
              BlocConsumer<CalculateResultBloc, CalculateResultState>(
                ...
                builder: (context, state) {
                  ...
                  if (state is CalculateResultFailed) {
                    ...
                    return CustomButton(
                        title: const SizedBox(
                            width: 150, child: Center(child: Text("الرسوم"))),
                        // color: AppColor.deepYellow,
                        onTap: () {
                          ...
                          BlocProvider.of<StepOrderBloc>(context)
                              .add(LoadSecondStep(
